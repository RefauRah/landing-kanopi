...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('successdelete', 'post berhasil dihapus (silahkan cek trashpost)');
    }
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('successupdate', 'post berhasil direstore (silahkan cek di post)');
    }
    ...
    public function kill($id){
        ...
        return redirect()->back()->with('successdelete', 'post berhasil dihapus permanen (silahkan cek di post)');
    }
}
